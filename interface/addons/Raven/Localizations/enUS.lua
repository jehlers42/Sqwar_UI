...
L["Warnings"] = true
L["Enable warnings about invalid spells."] = true
L["Reset"] = RESET
L["Reset color and label string"] = function(s) return string.format("Reset color, label, icon, sound and expire time for %s back to default.", s) end
L["Reset color and label confirm"] = function(s) return string.format("RESET SPELL\nAre you sure you want to reset the color, label, icon, sound and expire time for %s back to default?", s) end
L["Reset Colors"] = true
...
L["Use Spell"] = true
L["Use spell's expire time when set on the Spells tab (applies to special effects for both bar group and custom bars, if any)."] = true
