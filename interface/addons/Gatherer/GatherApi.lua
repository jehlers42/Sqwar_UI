--[[
	...
	Revision: $Id: GatherApi.lua 1148 2016-08-18 22:48:50Z ccox $
...
Gatherer_RegisterRevision("$URL: http://svn.norganna.org/gatherer/tags/REL_7.3.1/Gatherer/GatherApi.lua $", "$Rev: 1148 $")
...
function Gatherer.Api.AddGather(objectId, gatherType, indoorNode, gatherSource, gatherCoins, gatherLoot, wasGathered, gatherC, gatherZ, gatherX, gatherY)
	...
	elseif ( type(indoorNode) == "number" and indoorNode > 0 ) then
		...
		--print("Gatherer could not get indoor/outdoor status")
		return
	end
